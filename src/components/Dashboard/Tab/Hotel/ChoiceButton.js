...
export default function ChoiceButton({ description, price, image, square = true, onClick, selected = false }) {
  ...
  return (
    <ButtonStyle square={square} selected={selected} image={image} onClick={handlerClick}>
...
const ButtonStyle = styled.button`
  ...
  background-image: ${(props) => (props.selected ? `url("${props.image}")` : `url("${props.image}")`)};
